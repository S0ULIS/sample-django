...
function userGroupsRenderer(listUsers, listGroups, i){
    ...
    .then(users => {
        ...
        if(i<listGroups.length-1){
            ...
            //let addUserBtn = '<button type="button" id="showUserForm" class="nav-link"><i class="fa fa-plus" aria-hidden="true"></i> user</button>';

            //document.getElementById("v-pills-tab").appendChild(parseHTML(addUserBtn));
